...
ALTER TABLE "workflow_execution_logs" ALTER COLUMN "duration" SET DATA TYPE integer;--> statement-breakpoint
ALTER TABLE "workflow_executions" ALTER COLUMN "duration" SET DATA TYPE integer;--> statement-breakpoint
